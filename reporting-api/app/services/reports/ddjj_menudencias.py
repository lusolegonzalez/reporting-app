...
class DdjjMenudenciasReport:
    ...
    parametros: tuple[ReportParameter, ...] = (
        ReportParameter(
            ...
            descripcion="Fecha de produccion (emision de salida) - inicio del rango (DD-MM-YYYY).",
        ),
        ReportParameter(
            ...
            descripcion="Fecha de produccion (emision de salida) - fin del rango (DD-MM-YYYY).",
        ),
        ReportParameter(
            ...
            descripcion="Fecha de faena - inicio del rango (DD-MM-YYYY).",
        ),
        ReportParameter(
            ...
            descripcion="Fecha de faena - fin del rango (DD-MM-YYYY).",
        ),
        ReportParameter(
